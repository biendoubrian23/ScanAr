        ...
        <aside className="relative hidden flex-col overflow-hidden bg-[#f6f9f9] p-10 lg:flex">
          ...
          <div className="relative z-10 mt-12">
            <h2 className="text-[40px] font-bold leading-[1.05] tracking-tight text-gray-900">
              +30% de <span className="text-brand-500">ventes</span>.
            </h2>
            <p className="mt-3 text-[15px] text-gray-500">
              Transformez vos visiteurs en acheteurs grâce à la réalité augmentée.
            </p>
          </div>
            ...
            {success ? (
              ...
              >
                ...
                <Link
                  href="/login"
                  className={cn(
                    'inline-flex h-10 items-center justify-center gap-1.5 rounded-xl px-4 text-sm font-medium',
              ...
              <>
                <form onSubmit={handleSubmit} noValidate className="mt-7 space-y-4">
                  ...
                  <label className="block">
                    ...
                    <p className="mt-1.5 text-xs text-gray-400">Au moins 8 caractères</p>
                  </label>
