  ...
  return (
    <section className="relative lg:min-h-[54rem] flex items-start pt-6 pb-10 lg:pb-12 overflow-hidden bg-white">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 w-full">
        <div className="lg:max-w-[33rem] lg:pt-[5rem]">
          {/* Headline */}
          <motion.h1
            initial="hidden"
            animate="visible"
      ...
      <div className="mx-auto max-w-[100rem] px-6">
        ...
        >
          <Image
            ...
            width={2172}
            height={724}
            className="w-full h-auto scale-[0.9] origin-center"
...
function CreationFlowSection() {
  return (
    <section className="relative py-20 lg:py-28 bg-white overflow-hidden">
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-6 items-center mb-16 lg:mb-24">
          {/* Mobile-only title (appears first on mobile) */}
          <h2
          ...
          >
            <Image
              ...
              quality={92}
              className="w-full h-auto object-contain lg:scale-[1.18] origin-right"
            />
          </motion.div>
